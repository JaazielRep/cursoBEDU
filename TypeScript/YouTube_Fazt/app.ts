...
var string2: string = "Var String";
var number1: number = 10;
var boolean1: boolean = true;
var variableAny: any = "Hola, soy una variable any y puedo tener cualquier valor";
//Arrays
var stringArray1: string[] = ["a", "b", "c"];
var numberArray1: number[] = [1, 2, 3];
var booleanArray: boolean[] = [true, false];
var anyArray1: any[] = [true, "a", 5, {nombre:'ArrayAny'}];
var tupleArray1: [string, number, boolean] = [20+"", 2, true];
//void, null, undefined
var variableNull1: null = null;
var variableVoid1: void = undefined;
var variableUnde1: undefined = null;
console.log("   ");
...
function obj1(params:iObj) {
    return `${params.nombre} ${params.apellido}`;
}
var varObj1: iObj = {nombre:"Jaaziel", apellido:"Moreno"}
console.log("   ");
...
class Miembros1 extends Usuario1{
    id: number;

    constructor(idParam: number, nombre, mail, edad){
